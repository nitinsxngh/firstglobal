						...
						<div className="terms-and-conditions-wrapper">
							<div>
								<h2>
									Terms &amp; Conditions{" "}
									<span className="pill">
										Firstglobal.io – Corporate Business HTML Template
									</span>
								</h2>
								<p className="muted">Last updated: September 9, 2025</p>
								<p>
									Thank you for choosing{" "}
									<strong>First Global – Corporate Business HTML Template</strong> .
								...
								<div className="note">
									<strong>Short version:</strong> You can use Firstglobal.io on the
